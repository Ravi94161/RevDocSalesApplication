...
CustomKeywords.'pages.Profile.clickOnGoals'()

List<Integer> goalsValues = CustomKeywords.'pages.Profile.getCurrentMonthGoalsAndStoreGoals'()
...
CustomKeywords.'pages.Profile.selectCurrentMonthVerifyGoalsUpdatedOrNot'(goalsValues)
